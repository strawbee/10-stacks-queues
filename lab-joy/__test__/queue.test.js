...
describe('Queue Data Structure Module', () => {
    describe('Default Properties', () => {
        ...
        it('should have a maxSize property with a default val of 1048', () => {
            expect(queue.maxSize).toEqual(1048);
        });
    });
    ...
    describe('#Enqueue', () => {
        ...
        it('should add a new node with the value of 6, but the bottom should remain with a value of 1', () => {
            ...
            expect(queue.bottom.value).toEqual(1);
        });
    ...
    describe('#Dequeue', () => {
        ...
        it('should throw an error when the queue size is 0', () => {
            expect(() => {
                queue.dequeue();
            }).toThrow();
        });
    ...
    describe('#Peek', () => {
        ...
        it('should return the bottom of the queue', () => {
            queue.enqueue(1);
            expect(queue.peek().value).toEqual(1);
        });

        it('should return the bottom of the queue even when a new value is added', () => {
            queue.enqueue(2);
            expect(queue.peek().value).toEqual(1);
        });
    });
